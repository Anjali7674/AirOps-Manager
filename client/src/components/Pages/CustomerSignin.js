  ...
  return (
    <>
      <SEO
        ...
        description="Sign in to your AirOpsManager account to book flights, view your tickets, and manage your travel."
      ...
      <div className="flex-1 flex flex-col justify-center px-6 py-12 lg:px-16 bg-white">
        <div className="max-w-sm w-full mx-auto">
          ...
          <p className="text-center text-sm text-gray-500 mt-6">
            New customer?{' '}
            <Link to="/sign-up" className="text-sky-700 font-medium hover:underline">Create an account</Link>
          </p>
